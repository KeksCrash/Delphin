...
const char* fortune_messages[] = {
    ...
    "Erfolg ist nicht endgueltig, Misserfolg ist nicht fatal.",
    "Du bist zu erstaunlichen Dingen faehig.",
    "Traeume es. Glaube es. Erreiche es.",
    "Herausforderungen machen das Leben interessant.",
    "Das einzige Limit ist dein Geist.",
    "Atme tief durch und mach weiter.",
    "Sei der Grund, warum heute jemand laechelt.",
    "Du bist staerker, als du denkst.",
    "Kleine Schritte jeden Tag fuehren zu grossen Ergebnissen.",
    ...
    "Gewinnen ohne zu kaempfen ist der hoechste Sieg.",
    "Der Sieg gehoert dem Beharrlichsten.",
    "Traeume groesser. Handle groesser.",
    "Hoere nicht auf, wenn du muede bist. Hoere auf, wenn du fertig bist.",
    "Traeume es. Wuensche es. Tu es!",
    "Frauen mit Wuermchen und Warzen, lassen sich nur schwer verarzten ;)!",
    "Wenn du nicht mehr weiter weisst, dann Gruende einen Arbeitskreis!!!",
    ...
    "PS: Lern wirklich frueher!!!! Fuer Papa",
};
